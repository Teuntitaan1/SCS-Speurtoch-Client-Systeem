        ...
        <>	
            {Scanning === true ? 
                <div style={{display : 'flex', justifyContent : 'center', flexWrap : 'wrap',  width : 100+"%", height : 20+"rem"}}>
                    ...
                    <button onClick={() => {SetScanning(false);}} style={{height: 2+"rem", width: 50+"%", borderRadius : 5+"px", backgroundColor : "#457c1f", color : "#000000", marginTop : -1+"vh"}} >Stop met scannen</button>
                ...
                <div style={{display : 'flex', justifyContent : 'center'}}>
                    <img onClick={() => {SetScanning(true);}} src={QrCodeButton} alt="Qr code button"
