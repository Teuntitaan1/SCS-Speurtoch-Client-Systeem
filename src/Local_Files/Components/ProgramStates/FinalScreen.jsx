...
export default function FinalScreen(props) {
    ...
    <>
        ...
        <div style={{display : 'flex', justifyContent : 'center'}}>
            <button style={{backgroundColor : "#56a222", color : "#000000", borderRadius : 0.5+"rem", width : 12+"rem", height : 3+"rem"}} onClick={() => {props.ResetQuiz();}}>Ik heb mijn prijs gekregen!</button>
        </div>
        <div style={{display : 'flex', justifyContent : 'center'}}>
